...
如果你想要搭建一个类似的站点，可直接 [Fork](https://github.com/Fanceir/blog/fork) 本仓库使用，或者通过 [StackBlitz](https://stackblitz.com/github/Fanceir/blog) 在线运行本项目，通过 [Vercel](https://vercel.com/new/clone?repository-url=https://github.com/Fanceir/blog/tree/main&project-name=blog&repo-name=blog) 一键部署。
...
```bash
git clone https://github.com/Fanceir/blog.git
cd blog
pnpm install
pnpm start
```
